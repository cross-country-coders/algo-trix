  ...
  render() {
    const samplePane = [
      { menuItem: 'Sample 1', render: () => <Tab.Pane textAlign ='center'>
          Given an adjacency list representation of a graph G=(V,E), and assuming randomly
          distributed graphs, what is the time complexity in terms of V and E to determine
          whether an edge exists from vertex u to vertex v, and why?
      </Tab.Pane> },
